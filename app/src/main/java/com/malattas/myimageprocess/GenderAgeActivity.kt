...
class GenderAgeActivity : AppCompatActivity() {
    ...
    public override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == GALLERY)
        {
            if (data != null)
            {
                ...
                try
                {
                    ...
                    Toast.makeText(this@GenderAgeActivity, "Image saved! $path ", Toast.LENGTH_SHORT).show()
                    imageview!!.setImageBitmap(newBitmap)
                }
                catch (e: IOException) {
                    e.printStackTrace()
                    Toast.makeText(this@GenderAgeActivity, "Failed!", Toast.LENGTH_SHORT).show()
                }
            }
        }
        else if (requestCode == CAMERA)
        {
            ...
            saveImage(thumbnail)
            Toast.makeText(this@GenderAgeActivity, "Image saved!", Toast.LENGTH_SHORT).show()
        }
    }
